<div class="owl-stage-outer">
    <div class="owl-stage"
         style="transform: translate3d(-1402px, 0px, 0px); transition: all 0s ease 0s; width: 5612px; padding-left: 1px; padding-right: 1px;">
        <?php foreach ($products as $product): ?>
            <div class="owl-item active" style="width: 266.5px;margin-right: 14px;">
                    ...
                    <div class="block-products-carousel__cell">
                        <div class="product-card ">
                            ...
                            <div class="product-card__badges-list">
                                <div class="product-card__badge product-card__badge--new">Новый
                                </div>
                            </div>
                            <div class="product-card__image">
                                <a href="<?= $product->detailUrl; ?>"><img
                                            src="<?= $product->mainImg; ?>"
                                            alt="<?= $product->name; ?>"></a>
                            </div>
                            <div class="product-card__info">
                                ...
                                <ul class="product-card__features-list">
                                    <?= $product->generateAttr; ?>
                                </ul>
                            </div>
                            <div class="product-card__actions">
                                <div class="product-card__availability">
                                    Наличие: <span
                                            class="text-success"><?= $product->availibilty; ?></span>
                                </div>
